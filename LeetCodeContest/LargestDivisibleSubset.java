...
public class LargestDivisibleSubset {
    ...
    public List<Integer> largestDivisibleSubset(int[] nums) {
        List<Integer> maxRet = new ArrayList<>();
        ...
        for (int l = 0; l < nums.length; l++) {
            ...
            for (int i = 0; i < nums.length; i++) {
                ...
                for (int j = 0; j < retSize; j++) {
                    if (ret.get(j) % nums[i] != 0 && nums[i] % ret.get(j) != 0) {
                        flag = false;
                        break;
                    }
                }
            ...
            if (ret.size() > maxRet.size()) {
                maxRet.clear();
                maxRet.addAll(ret);
            }
        }

        Collections.sort(maxRet);
        return maxRet;
    }
    ...
    public void test() {
        ...
        //assertThat(largestDivisibleSubset(nums), is(expected));
